...
// import { banListing } from "@/lib/supabase/listings"
...
//       [title, category, reason, sellerEmail,status].some((f) => f.toLowerCase().includes(q))
//     )
//   }, [query, listings])
//   // when the user clicks “Remove” in the table row:
//   const onRemoveClick = (listing) => {
...
import RemoveDialog from "@/components/flagged-listings/removeDialog"
import Loading from "./loading"
import { banListing, unbanListing } from "@/lib/supabase/listings"   // ← import unban
